...
# Prepare for Logging
Write-Log " "
Write-Log "Configure ccmexec service"

try
{
	Set-Service -Name "CcmExec" -StartupType AutomaticDelayedStart
	Write-Log "Setting ccmexec service to automatic delayed (default)"
}
catch { Write-Log "Could not restore ccmexec service" }
