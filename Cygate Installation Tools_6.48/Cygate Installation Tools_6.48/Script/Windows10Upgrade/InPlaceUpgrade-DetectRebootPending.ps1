...
# Prepare for Logging
Write-Log " "
Write-Log "Detecting Reboot Pending"
...
$RebootPending = $result.ContainsValue($true)
Write-Log "Reboot Pending detected as: $RebootPending"
$tsenv.Value("OSDRebootPending") = $RebootPending
